...
-- CreateEnum
CREATE TYPE "TicketCategory" AS ENUM ('BILLING', 'GENERATION', 'ACCESS', 'OTHER');
...
-- CreateIndex
CREATE UNIQUE INDEX "affiliate_profiles_couponCode_key" ON "affiliate_profiles"("couponCode");

-- CreateIndex
CREATE UNIQUE INDEX "coupon_usages_userId_couponCode_key" ON "coupon_usages"("userId", "couponCode");
...
-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_affiliateId_fkey" FOREIGN KEY ("affiliateId") REFERENCES "affiliate_profiles"("id") ON DELETE SET NULL ON UPDATE CASCADE;
